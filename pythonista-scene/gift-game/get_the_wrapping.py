...
class getTheWrapping (Scene):
	...
	def update(self):
		if self.totalFrames < 1800:
			...
			getTheWrapping.end(self)
			self.totalFrames += 100
		elif self.totalFrames == 1900:
			getTheWrapping.clear(self)
			self.totalFrames += 100
		elif self.totalFrames == 2000:
			getTheWrapping.score(self)
			self.totalFrames += 100
...
if __name__ == '__main__':
	run(getTheWrapping(), show_fps=False)
